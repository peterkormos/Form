...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
        ...
        <tr valign="top"> 
          ...
          <td bgcolor="#FFBFBF"> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_DELETE_POLL%>">
              Szavaz&aacute;s: 
        ...
        <tr valign="top"> 
          ...
          <td bgcolor="#FF9797"> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_ASSIGN_POLL%>">
              Szavaz&aacute;s: 
              <select name="<%=PollsServlet.POLL_ID%>">
                <%
        ...
        <tr valign="top"> 
          ...
          <td bgcolor="#FFBFBF"> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_DELETE_VOTE%>">
              Szavaz&aacute;s: 
              <select name="<%=PollsServlet.POLL_ID%>">
                <%
					  for (Poll poll : user.getOwnedPolls())
        ...
        <tr valign="top">
          ...
          <td bgcolor="#FF9797"><form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              ...
              <select
					name="<%=PollsServlet.DELETED_USER_ID%>">
                <%
        ...
        <tr valign="top" bgcolor="#FFBFBF"> 
          ...
          <td> 
            <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_DELETE_USER%>">
              Felhaszn&aacute;l&oacute;: 
              <select
					name="<%=PollsServlet.DELETED_USER_ID%>">
                <%
