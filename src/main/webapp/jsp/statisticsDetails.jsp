		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<th width="180">
					<div align="left">Eloszl&aacute;s (
min: <img src='./images/red.jpg' width='10' height='10'>
max: <img src='./images/green.jpg' width='10' height='10'>
avg: <img src='./images/grey.jpg' width='10' height='10'> ) 
					</div>
					</th>
				</tr>
				<%
				...
				<tr>
					...
					<%
					  if (min*1.1 >= entry.count)
					      out
					          .println("<img src='./images/red.jpg' width='"+Math.max(1, (int)(entry.count*100/votes.size()))+"' height='10'>");

					    else if (max*0.9 <= entry.count)
					      out
					          .println("<img src='./images/green.jpg' width='"+Math.max(1, (int)(entry.count*100/votes.size()))+"' height='10'>");

					    else if (avg*0.9 <= entry.count &&
					        avg*1.1 >= entry.count)
					      out
					          .println("<img src='./images/grey.jpg' width='"+Math.max(1, (int)(entry.count*100/votes.size()))+"' height='10'>");
					%>
					</td>
				</tr>
				<%
