...
<input type="hidden" name="<%=PollsServlet.COMMAND%>"
	value="<%=PollsServlet.COMMAND_LOGOUT%>"> Bejelentkezett
...
<%
  String message = (String) session
      .getAttribute(PollsServlet.MESSAGE_IN_HTTPSESSION);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<%
		  out.println(message);
		    session.removeAttribute(PollsServlet.MESSAGE_IN_HTTPSESSION);
		%>
		</td>
	</tr>
</table>
	...
	<tr>
        ...
        <tr valign="top"> 
          ...
          <td bgcolor="#E0E0E0"> <form accept-charset="UTF-8" action="inputVote.jsp" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>">
              Szavaz&aacute;s: 
              <select name="<%=PollsServlet.POLL_ID%>">
                <%
        ...
        <tr valign="top"> 
          ...
          <td> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_SUBSCRIBE_TO_POLL%>">
              Szavaz&aacute;s: 
              <select name="<%=PollsServlet.POLL_ID%>">
                <%
					  for (int i = 0; i < allVisiblePolls.length; i++)
        ...
        <tr valign="top"> 
          ...
          <td> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_UNSUBSCRIBE_FROM_POLL%>">
              Szavaz&aacute;s: 
              <select name="<%=PollsServlet.POLL_ID%>">
                <%
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	<tr>
        ...
        <tr valign="top"> 
          ...
          <td> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_SAVE_GROUP%>">
              Csoport: 
              <input
					type="text" name="<%=PollsServlet.GROUP_NAME%>">
              <input
        ...
        <tr valign="top"> 
          ...
          <td bgcolor="#E0E0E0"> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_ADD_POLL_TO_GROUP%>">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="23%">Csoport:</td>
                  <td width="77%"><select
							name="<%=PollsServlet.POLL_GROUP_ID%>">
                      <%
                ...
                <tr> 
                  ...
                  <td width="77%"><select name="<%=PollsServlet.POLL_ID%>">
...
<input type="button" onClick="this.parentNode.submit();"
        ...
        <tr valign="top"> 
          ...
          <td> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_ADD_USER_TO_GROUP%>">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="23%">Csoport:</td>
                  <td width="77%"><select
                ...
                <tr> 
                  ...
                  <td><textarea name="<%=PollsServlet.SUBSCRIBE_USER_ID%>"
							cols="50"></textarea></td>
                </tr>
              </table>
               <input type="button" onClick="this.parentNode.submit();"
        ...
        <tr valign="top"> 
          ...
          <td bgcolor="#E0E0E0"> <form accept-charset="UTF-8" action="../PollsServlet" method="POST">
              <input type="hidden" name="<%=PollsServlet.COMMAND%>"
					value="<%=PollsServlet.COMMAND_SEND_EMAILS_TO_GROUP%>">
              Szavaz&aacute;s: 
              <select name="<%=PollsServlet.POLL_ID%>">
                <%
					  for (Record record : dao.getPollsFromGroups(user.getPollGroups()))
					  {
					    ...
					    out.println("<option value='" + poll.id
					        ...
					        + PollsServlet.COMMAND_SEND_EMAILS_TO_GROUP + "' )\">" + poll.title
					        + "</option>");
					  }
					%>
              </select>
