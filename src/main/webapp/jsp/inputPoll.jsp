...
<body>
		...
		<table border="0" cellpadding="0" cellspacing="0">
		  ...
		  PollsServlet.DATE_PATTERN)%>">
			...
			<tr bgcolor="<%=highlight(request)%>">
				...
				<td><select id="<%=HTTPRequestParamNames.POLL_CLASS%>"
					name="<%=HTTPRequestParamNames.POLL_CLASS%>" size="5">
						<option value="org.msz.servlet.datatype.polls.SingleDecisionPoll"
						...
						<option value="org.msz.servlet.datatype.polls.MultiDecisionPoll"
							...
							kiv&aacute;laszt&aacute;sa</option>
						<option value="org.msz.servlet.datatype.polls.SplitPointsPoll"
			...
			<tr style='visibility: hidden' id="units">
				...
				<td><input name="<%=HTTPRequestParamNames.UNITS%>" type="text"
 ...
 %>
						...
						<tr bgcolor="<%=highlight(request)%>">
							<td>
								<table border="0" id="tableID" width="100%">
								</table>
								<p align="center">
